...
class EditAccess extends Component {
    ...
    async getLocations(){
        ...
        if (level == 1) {
            ...
            url = "http://localhost:3000/api/dens/locations/c/" + this.state.identifier;
        }
            ...
            return (
                <Grid display="flex" container spacing={3} style={{
                    ...
                    <Grid item sm={12} md={12}>
                      <NewTable columns={this.state.tableColumns} dens={this.state.usersList} title={"Users access"}/>   
                    </Grid>
                    ...
                    <Grid item sm={12} md={12}>
                        ...
                        <Form style={{ 
                            width: "95%", 
                            margin: "auto",
                            padding: "1rem"}} onSubmit={this.handleSubmit}>
                        <Form.Group controlId="hideCouserControlntrol">
                            <Form.Label>User</Form.Label>
                            <Form.Control name="enteredUsername" as="select" onChange={this.handleChange}>
                        ...
                        <Form.Group controlId="locationControl">
                            ...
                            <Form.Control name="enteredLocation" as="select" onChange={this.handleChange}>
                        ...
                        <Form.Group controlId="countryControl">
                            ...
                            <Form.Control name="enteredCountry" as="select" onChange={this.handleChange}>
                        ...
                        <Form.Group controlId="authLevelControl">
                            ...
                            <Form.Control name="enteredLevel" as="select" onChange={this.handleChange}>
